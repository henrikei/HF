...
//-----------------------------------------------------------------------------------------------------------------
void HartreeFock::setPositions(mat newNucleiPos){
...
//----------------------------------------------------------------------------------------------------
double HartreeFock::getOneElectronIntegral(int i, int j){
...
//-------------------------------------------------------------------------------------------------------------------------------------
double HartreeFock::getTwoElectronIntegral(int i, int j, int k, int l){
...
//---------------------------------------------------------------------------------------------------------------
double HartreeFock::getOverlapIntegral(int i, int j){
